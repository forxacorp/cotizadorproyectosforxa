...
//
// Paleta: reutiliza los colores de marca ya definidos en css/styles.css (el
// oliva/arena de FORXA + los colores propios de cada proyecto) en vez de
// una paleta de gráficos genérica, para que el dashboard se sienta parte
// del mismo sistema visual y no una librería pegada encima.

const CHART_PALETTE = [
  '#565a41', // olive (marca FORXA)
  '#2d3b52', // AURA
  '#b5633f', // terracota (acento propio del dashboard)
  '#cdbd94', // arena (marca FORXA)
  '#6a3226', // Álabes
  '#7c5a2c', // Portón del Valle
  '#3a392f', // carbon-soft
  '#8a9a7e', // verde suave (derivado del oliva, para series largas)
];
